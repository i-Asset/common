package at.srfg.iot.common.datamodel.indexing;
...
/**
 * Annotated interface for the main cores, e.g. {@link SubmodelType},
...
public interface SubmodelTypeIndexing {
	/**
	...
	@RequestMapping(
			...
			path="/modelType")
	@ApiOperation("Obtain a Concept Class (SubmodelType) from the class collection")
	Optional<SubmodelType> getSubmodelType(
//			@RequestHeader(value = "Authorization") 
//			String bearerToken,
			@ApiParam("Identifier of the requested SubmodelType")
	...
	@RequestMapping(
			method = RequestMethod.GET,
			path="/modelType/fields")
	@ApiOperation(
			value = "Get field definitions for SubmodelType index", 
			notes = "Obtain the field descriptors (IndexField) from the asset collection")
	Collection<IndexField> fieldsForSubmodelType(
	...
	/**
	 * Perform a search in the {@link SubmodelType} collection
	 * @param query
	 * @param filterQuery
	 * @param facetFields
	 * @param facetLimit
	...
	@RequestMapping(
			method = RequestMethod.GET,
			path="/modelType/select")
	@ApiOperation(
			value = "Search in the collection for SubmodelType objects", 
			notes = "Perform a search by providing the distinct parameters")
	SearchResult<SubmodelType> searchForSubmodelType(
	...
	/**
	 * Perform a {@link Search} in the {@link SubmodelType} collection
	...
	@RequestMapping(
			...
			path="/modelType/select")
	public SearchResult<SubmodelType> searchForSubmodelType(
	...
	@RequestMapping(
			method = RequestMethod.GET,
			path="/modelType/suggest")
	FacetResult suggestForSubmodelType(
//			@RequestHeader(value = "Authorization") 
//			String bearerToken,
	...
	/**
	 * Store a new or update an existing {@link SubmodelType} object
	 * @param prop
	 * @return The stored version of the modelType
	 * @throws Exception
	 */
	@ApiOperation(
			value = "Create or update a SubmodelType", 
			notes = "Store the provided SubmodelType object in the index, will also "
					+ "create/update Properties including the links between SubmodelType and PropertyType ...")
	@RequestMapping(
			method = RequestMethod.POST,
			path="/modelType")
	public SubmodelType setSubmodelType(
//			@RequestHeader(value = "Authorization") 
//			String bearerToken,
			@RequestBody SubmodelType prop) throws Exception;
	/**
	...
	@RequestMapping(
			...
			path="/modelType")
	@ApiOperation(
			value = "Delete a SubmodelType element from the index", 
			notes = "The entry is removed, corresponding links from PropertyType are also removed!")
	public boolean deleteSubmodelType(
