 ...
 */
@Embeddable
public class ReferableDescriptionPK implements Serializable {
	...
	public ReferableDescriptionPK() {
	}
	public ReferableDescriptionPK(ReferableElement element_id, String language) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReferableDescriptionPK other = (ReferableDescriptionPK) obj;
		if (language == null) {
