package at.srfg.iot.common.solr.indexing.core.solr.query;
...
public class SolrJoin {
	...
	private SolrJoin(java.lang.reflect.Field field, at.srfg.iot.common.solr.model.model.solr.annotation.SolrJoin joinAnnotation) {
	 ...
	 * The <code>joinName</code> is used to identify field annotated with {@link at.srfg.iot.common.solr.model.model.solr.annotation.SolrJoin}
    ...
    public static Optional<SolrJoin> findJoin(Class<?> sourceClass, String joinName) {
    	...
    	for ( java.lang.reflect.Field f : fields) {
    		at.srfg.iot.common.solr.model.model.solr.annotation.SolrJoin joinAnnotation = f.getAnnotation(at.srfg.iot.common.solr.model.model.solr.annotation.SolrJoin.class);
    		// 
