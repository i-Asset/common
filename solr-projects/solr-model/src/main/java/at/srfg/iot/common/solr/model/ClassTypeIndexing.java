package at.srfg.iot.common.solr.model;
...
public interface ClassTypeIndexing {
	/**
	...
	@RequestMapping(
			...
			path="/classType")
	@ApiOperation("Obtain a Concept Class (ClassType) from the class collection")
	Optional<ClassType> getClassType(
//			@RequestHeader(value = "Authorization") 
//			String bearerToken,
			@ApiParam("Identifier of the requested ClassType")
	...
	@RequestMapping(
			method = RequestMethod.GET,
			path="/classType/fields")
	@ApiOperation(
			value = "Get field definitions for ClassType index", 
			notes = "Obtain the field descriptors (IndexField) from the class collection")
	Collection<IndexField> fieldsForClassType(
	...
	@RequestMapping(
			method = RequestMethod.GET,
			path="/classType/select")
	@ApiOperation(
			value = "Search in the collection for ClassType objects", 
			notes = "Perform a search by providing the distinct parameters")
	SearchResult<ClassType> searchForClassType(
	...
	/**
	 * Perform a {@link Search} in the {@link ClassType} collection
	...
	@RequestMapping(
			method = RequestMethod.GET,
			path="/classType/suggest")
	FacetResult suggestForClassType(
//			@RequestHeader(value = "Authorization") 
//			String bearerToken,
