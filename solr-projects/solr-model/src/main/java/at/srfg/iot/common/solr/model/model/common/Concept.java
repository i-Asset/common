package at.srfg.iot.common.solr.model.model.common;
...
/**
 * Base concept class for all SOLR Collection types. 
 * <p>
...
public abstract class Concept implements IConcept {
	...
	/**
	 * The local name (as part of the full identifier)
	 */
	@Indexed(name=LOCAL_NAME_FIELD)
	protected String localName;
	/**
	 * The name space (as part of the full identifier)
	 */
	...
	@Indexed(name=ALTERNATE_LABEL_FIELD, type=SOLR_STRING, copyTo= {LANGUAGE_TXT_FIELD, TEXT_FIELD, ALL_LABELS_FIELD, LANGUAGE_ALL_LABELS_FIELD})
	@Dynamic
	protected Map<String, Collection<String>> alternateLabel;
	@Indexed(name=HIDDEN_LABEL_FIELD, type=SOLR_STRING, copyTo= {LANGUAGE_TXT_FIELD, TEXT_FIELD, ALL_LABELS_FIELD, LANGUAGE_ALL_LABELS_FIELD})
	@Dynamic
	...
	/**
	 * Holds multilingual comments on the current concept. One comment per language
	 */
	@Dynamic
	protected Map<String, String> comment;
	
//	// custom properties
//	@Indexed(name=CUSTOM_DOUBLE_PROPERTY, type="pint") @Dynamic
//	private Map<String, Collection<Integer>> customIntValues = new HashMap<>();
//	@Indexed(name=CUSTOM_DOUBLE_PROPERTY, type="pdouble") @Dynamic
//	private Map<String, Collection<Double>> customDoubleValues = new HashMap<>();
//	@Indexed(name=CUSTOM_STRING_PROPERTY, type="string") @Dynamic
//	private Map<String, Collection<String>> customStringValues = new HashMap<>();
//	@Indexed(name=CUSTOM_BOOLEAN_PROPERTY, type="boolean") @Dynamic
//	private Map<String, Boolean> customBooleanValue;
//	@Indexed(name=CUSTOM_KEY_FIELD) @Dynamic
...
//	private Map<String, PropertyType> customProperties; 
	...
	public String getLabel(Locale locale) {
		return label.get(locale.getLanguage());
	}
